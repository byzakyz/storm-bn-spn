...
struct BIF{
    ...
    std::string expression = "(" + LETTER + "|" + DIGIT + ")" + "+" + "(" + LETTER + "|" + DIGIT + "|" + "[+]" + "|" + "[-]" + ")" + "*";
    std::string MARKS = "[+-=<>]";
    ...
    std::string variableDiscrete = VARIABLETYPE + SPACEPLUS + DISCRETE + SPACESTAR + dimensionDefinition + SPACESTAR +
                                   + "[{]" +  variableValuesList + "[}]" + "[;]"  ;
    std::string variableDeclaration = VARIABLE + SPACEPLUS + variableName  + SPACESTAR + "[{]" + SPACESTAR + variableDiscrete + SPACESTAR + "[}]" + SPACESTAR;

    std::string Seperator = "[ ,\t\n\r]*";
    std::string floatingPointList = FLOATING_POINT_LITERAL + "(" + Seperator + FLOATING_POINT_LITERAL + ")" + "*" + SPACESTAR + "[;]";
    std::string expressionList = expression + "(" + Seperator + expression + ")" + "*" + SPACESTAR + "[;]";
    std::string probabilityVariableName = variableValue;
    std::string probabilityVariableList = OPEN_PARAN + SPACESTAR + probabilityVariableName  + "(" + SPACESTAR + probabilityVariableName + ")" + "*" + SPACESTAR + CLOSE_PARAN;
    std::string probabilityEntry = SPACESTAR + probabilityVariableList + SPACEPLUS + "(" + floatingPointList + "|" + expressionList + ")" + SPACESTAR;
    ...
    std::string probabilityContent =  "(" + SPACESTAR +  property + "|" + probabilityDefualtEntry + "|"  + probabilityTable + "|" + probabilityEntry + SPACESTAR + ")" + "*";
    std::string probabilityDeclaration = SPACESTAR + PROBABILITY + SPACEPLUS + probabilityVariableList + SPACESTAR  + "[{]" + SPACESTAR + probabilityContent + SPACESTAR + "[}]" + SPACESTAR;
    ...
    std::string assignment = SPACESTAR + variableName + SPACESTAR + EQUALS + SPACESTAR + variableValue + SPACESTAR + "[;]" + SPACESTAR;
    ...
    std::string parametersDeclaration = PARAMETER + SPACEPLUS + parameterName +
                                        SPACESTAR + "[{]"  + SPACESTAR + "[}]";
    std::string compilationUnit = networkDeclaration + SPACESTAR + "(" + variableDeclaration + SPACESTAR +  "? |"  + probabilityDeclaration + SPACESTAR + "? |" + hypothesisDeclaration + SPACESTAR + "? |" + evidenceDeclaration + SPACESTAR  + ")" + "*" + SPACESTAR;
